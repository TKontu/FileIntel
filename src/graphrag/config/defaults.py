...
DEFAULT_CHAT_MODEL = "gemma3-12b-awq"
...
class EmbedTextDefaults:
    ...
    batch_size: int = 16
    batch_max_tokens: int = 400  # Conservative default for 512 token embedding models
...
class LanguageModelDefaults:
    ...
    tokens_per_minute: int = 100000000  # 100M tokens per minute for local server
    requests_per_minute: int = 100000  # 100k requests per minute for local server
