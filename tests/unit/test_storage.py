...
from src.document_analyzer.storage.postgresql_storage import PostgreSQLStorage
from src.document_analyzer.storage.models import Document, Job, Result
import uuid
...
class TestPostgreSQLStorage(unittest.TestCase):
    ...
    def test_get_job(self):
        ...
        self.mock_db_session.query.return_value.filter.return_value.first.return_value = mock_job
    ...
    def test_get_result(self):
        ...
        self.mock_db_session.query.return_value.filter.return_value.first.return_value = mock_result
